// ====================================================================
//  我的音源后端 — lx 自定义源专用取址服务
//  - 网易云搜索 / 歌曲URL / 封面/音频代理
//  - 扫码登录 (login_qr_*) + cookie 持久化 (./.netease-cookie)
...
const COOKIE_FILE = process.env.COOKIE_FILE || path.join(__dirname, '.netease-cookie');
...
server.listen(PORT, HOST, () => {
  console.log('======================================================');
  console.log(' 我的音源后端  →  http://' + HOST + ':' + PORT);
  console.log(' 网易云: ' + (userCookie ? '已登录' : '未登录') + '   QQ: ' + (qqCookie ? '已登录' : '未登录'));
  console.log(' lx 自定义源请保持此窗口开启');
  console.log('======================================================');
});
